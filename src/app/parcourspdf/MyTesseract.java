 ...
 */
public class MyTesseract implements ITesseract {

	private static MyTesseract instance;
	 ...
	 */
	@Deprecated
	public static synchronized MyTesseract getInstance() {
		if (instance == null) {
			instance = new MyTesseract();
		}
